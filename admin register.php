...
<div class="container" id="signUpAdmin">
      ...
      <form method="post" action="register.php">
        ...
        <div class="input-group">
            ...
            <input type="password" name="AdminCode" id="AdminCode" placeholder="Admin code" required>
            <label for="AdminCode">Creat Admin Code</label>
        </div>
 ...
 <div class="container" id="signInAdmin" style="display:none;">
